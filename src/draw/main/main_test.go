...
func TestCalc(t *testing.T) {
	...
	// 2*0.2 + 2*(1-0.2)*0.2 + 4*[(1-0.2)*(1-0.2)]*0.3 + 4*[(1-0.2)*(1-0.2)*(1-0.3)]*0.3 + 6*[(1-0.2)*(1-0.2)*(1-0.3)*(1-0.3)]*1
	assertAppoxEqual(3.9072, calc(0.2, 0.1, 2, 1, 1, 6), t)

	// 3*0.2 + 3*(1-0.2)*0.2 + 3*[(1-0.2)*(1-0.2)]*0.2 + 6*[(1-0.2)*(1-0.2)*(1-0.2)]*0.3 + 6*[(1-0.2)*(1-0.2)*(1-0.2)*(1-0.3)]*1
	assertAppoxEqual(4.536, calc(0.2, 0.1, 3, 1, 1, 5), t)

	// 2*0.4 + 2*(1-0.4)*0.4 + 4*[(1-0.4)*(1-0.4)]*0.6 + 4*[(1-0.4)*(1-0.4)*(1-0.6)]*0.6 + 6*[(1-0.4)*(1-0.4)*(1-0.6)*(1-0.6)]*1
	assertAppoxEqual(2.8352, calc(0.2, 0.1, 2, 2, 2, 5), t)

	// 3*0.4 + 3*(1-0.4)*0.4 + 3*[(1-0.4)*(1-0.4)]*0.4 + 6*[(1-0.4)*(1-0.4)*(1-0.4)]*0.6 + 6*[(1-0.4)*(1-0.4)*(1-0.4)*(1-0.6)]*1
	assertAppoxEqual(3.648, calc(0.2, 0.1, 3, 2, 2, 5), t)
